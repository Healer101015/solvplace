      ...
      <section className="relative text-white py-24 lg:py-32 px-4 overflow-hidden bg-[#001F3F]">
        ...
        <div className="max-w-7xl mx-auto relative z-10 flex flex-col lg:flex-row items-center gap-16">
          ...
          <div className="flex-1 text-center lg:text-left space-y-8">
            ...
            <div className="inline-flex flex-col sm:flex-row items-center gap-2 bg-white/5 border border-white/10 text-[#00BFFF] text-xs font-bold px-4 py-2 rounded-full uppercase tracking-wider backdrop-blur-md shadow-lg">
              ...
              <span className="text-[#00BFFF]">Frete Grátis (Consulte condições)</span>
            </div>
            ...
            <h1 className="text-4xl md:text-6xl font-extrabold tracking-tight leading-[1.1] text-white">
              ...
              <span className="block mt-2 text-transparent bg-clip-text bg-gradient-to-r from-[#00BFFF] to-[#00D4FF] drop-shadow-lg">
                cuida de verdade.
              </span>
            </h1>

            <p className="text-xl md:text-2xl text-slate-200 font-medium max-w-2xl mx-auto lg:mx-0 border-l-4 border-[#00BFFF] pl-4">
              SOLVPLACE — Confiança que resolve. <br />
              <span className="text-slate-400 font-light">Qualidade que permanece.</span>
            </p>

            <p className="text-base text-slate-300 max-w-lg mx-auto lg:mx-0 pt-2">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start pt-6">
              <a href="#orcamento-form" className="group bg-[#00BFFF] hover:bg-[#00D4FF] text-[#001F3F] font-bold py-4 px-8 rounded-xl shadow-[0_0_20px_rgba(0,191,255,0.3)] transition-all duration-300 hover:-translate-y-1 flex items-center justify-center gap-3 text-lg">
              ...
              <button
                onClick={handleShare}
                className="group bg-transparent hover:bg-[#00BFFF]/10 text-white border border-[#00BFFF]/50 font-semibold py-4 px-6 rounded-xl transition-all duration-300 hover:-translate-y-1 flex items-center justify-center gap-2 backdrop-blur-sm"
              >
          ...
          <div className="flex-1 relative w-full max-w-lg lg:max-w-none hidden md:block">
            <div className="relative z-10 grid grid-cols-2 gap-4 lg:gap-6">
              {[
                ...
                { title: "Android", sub: "Samsung e outros", icon: <path d="M17 2H7a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h10a2 2 0 0 0 2-2V4a2 2 0 0 0-2-2zM7 20V4h10v16H7z" />, color: "text-[#00BFFF]" },
                ...
                { title: "Notebooks", sub: "Todas as marcas", icon: <path d="M20 16V7a2 2 0 0 0-2-2H6a2 2 0 0 0-2 2v9m16 0H4m16 0 1.28 2.55a1 1 0 0 1-.9 1.45H3.62a1 1 0 0 1-.9-1.45L4 16" />, color: "text-[#00BFFF]" },
              ].map((card, idx) => (
                <div key={idx} className={`bg-[#0A1D37]/50 backdrop-blur-xl border border-[#00BFFF]/20 p-6 rounded-2xl shadow-2xl flex flex-col justify-between h-40 transform transition hover:scale-105 hover:bg-[#001F3F] ${idx % 2 !== 0 ? 'translate-y-8' : ''}`}>
                  <div className={`p-3 bg-gradient-to-br from-[#00BFFF]/20 to-transparent w-fit rounded-lg ${card.color}`}>
                    <Icon path={card.icon} className="w-8 h-8" />
                  </div>
                  <div>
                    <h3 className="text-white font-bold text-lg">{card.title}</h3>
                    <p className="text-[#889dbf] text-xs mt-1">{card.sub}</p>
                  </div>
                </div>
              ))}
            </div>
