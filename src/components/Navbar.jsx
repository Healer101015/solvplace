      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between h-20 items-center">
          ...
          <div className="hidden md:flex items-center space-x-4 lg:space-x-6">
            ...
            {/* BOTÃO DE CONTATO (Verde WhatsApp) */}
            <a
              href="https://wa.me/5511952924711"
              className="bg-[#25D366] text-white px-6 py-2.5 rounded-full font-bold shadow-[0_0_15px_rgba(37,211,102,0.4)] hover:bg-[#20bd5a] hover:shadow-[0_0_25px_rgba(37,211,102,0.6)] transform hover:-translate-y-0.5 transition-all duration-200 flex items-center gap-2"
            >
